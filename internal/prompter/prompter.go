...
2. Call read_spec to read the current specification of the relevant plan
3. Adapt the specification to satisfy the user's request
4. Call update_spec with the modified specification
